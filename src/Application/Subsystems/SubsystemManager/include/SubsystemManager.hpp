 ...
 * @details Порядок вызова метода @ref process подсистемы зависит от порядка добавления подсистемы в список менеджера.
 */
...
private:
  ...
  static constexpr size_t subsystemCount_ = static_cast<size_t>(Subsys::SubsystemId::Count) - 1u;
  /// @brief Подсистемы.
